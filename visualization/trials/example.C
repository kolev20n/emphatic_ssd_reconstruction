...
private:
  TGMainFrame         *fMain;
  TRootEmbeddedCanvas *ec1, *ec2, *ec3, *ec4, *ec5;
...
{
  //in_file.open("temp_debug_midstream_downstream_single_track.txt", ios::in);
  ...
  ec3 = new TRootEmbeddedCanvas("Ecanvas3",f2,1200,600);
  ec4 = new TRootEmbeddedCanvas("Ecanvas4",f2,1200,600);
  ec5 = new TRootEmbeddedCanvas("Ecanvas5",f2,1200,600);
  ...
  f2->AddFrame(ec3, new TGLayoutHints(kLHintsExpandX | kLHintsExpandY, 10,10,10,1));
  f2->AddFrame(ec4, new TGLayoutHints(kLHintsExpandX | kLHintsExpandY, 10,10,10,1));
  f2->AddFrame(ec5, new TGLayoutHints(kLHintsExpandX | kLHintsExpandY, 10,10,10,1));
